...
impl Tool for ReadFileTool {
    ...
    fn metadata(&self) -> agent_base::ToolMetadata {
        agent_base::ToolMetadata {
            ...
            description: "Read a file (workspace-relative or absolute) with line numbers and pagination support.".to_string(),
